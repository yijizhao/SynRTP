...
from algorithm.rankepta.transformer import TransformerEncoder
...
class MLP(torch.nn.Module):
    ...
    def __init__(self, input_dim, embed_dims, dropout=0, output_layer=True):
        ...
        for embed_dim in embed_dims:
            ...
            input_dim = embed_dim
        if output_layer:
            layers.append(torch.nn.Linear(input_dim, 25)) 
...
class RankEPTA(nn.Module):
    def __init__(self, args):
        ...
        self.mlp_eta = MLP( args['max_task_num'] * self.sort_x_size + self.hidden_size + 5, (self.hidden_size,self.hidden_size,),dropout=0.1)
