...
class ModelDataset(Dataset):
    def __init__(self, V, V_reach_mask, label, label_len, V_at, sort_idx,  sample_num, start_fea):
    ...
    def __getitem__(self, index):
        ...
        start_fea = self.start_fea[index]
        return V, V_reach_mask, label, label_len, V_at, sort_idx, start_fea
