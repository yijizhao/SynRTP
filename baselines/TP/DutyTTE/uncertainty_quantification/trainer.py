...
class Trainer:
    ...
    def generated_path_eta_uq(self, args):
        ...
        pickle_file_path_train = os.path.join(
            ws, f"datasets/dutytte/{args.dataset}/train.pkl"
        )
        ...
        pickle_file_path_val = os.path.join(
            ws, f"datasets/dutytte/{args.dataset}/val.pkl"
        )
        ...
        pickle_file_path_test = os.path.join(
            ws, f"datasets/dutytte/{args.dataset}/test.pkl"
        )
        ...
        result_file = f'val_.{args.dataset}.txt'  
